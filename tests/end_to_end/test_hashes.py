...
async def test_async_empty_to_equal():
    conf1 = await rxconf.Conf.from_file_async(config_path=_RESOURCE_DIR / "empty.ini")
    conf2 = await rxconf.Conf.from_file_async(config_path=_RESOURCE_DIR / "empty.yaml")
    conf3 = await rxconf.Conf.from_file_async(config_path=_RESOURCE_DIR / "empty.env")
    conf4 = await rxconf.Conf.from_file_async(config_path=_RESOURCE_DIR / "empty.toml")
    conf5 = await rxconf.Conf.from_file_async(config_path=_RESOURCE_DIR / "empty.json")
    assert conf1 == conf2
    assert conf2 == conf3
    assert conf3 == conf4
    assert conf4 == conf5
...
async def test_async_same_attribute_structures():
    conf1 = await rxconf.Conf.from_file_async(config_path=_CONF_HASH_DIR / "simple_structure.ini")
    conf2 = await rxconf.Conf.from_file_async(config_path=_CONF_HASH_DIR / "simple_structure.yml")
...
async def test_async_list_and_set_to_differ():
    conf1 = await rxconf.Conf.from_file_async(config_path=_CONF_HASH_DIR / "yaml_with_list.yaml")
    conf2 = await rxconf.Conf.from_file_async(config_path=_CONF_HASH_DIR / "yaml_with_set.yaml")
...
async def test_async_list_order_matters():
    conf1 = await rxconf.Conf.from_file_async(config_path=_CONF_HASH_DIR / "list_123.toml")
    conf2 = await rxconf.Conf.from_file_async(config_path=_CONF_HASH_DIR / "list_132.toml")
...
async def test_async_inner_structures():
    conf1 = await rxconf.Conf.from_file_async(config_path=_CONF_HASH_DIR / "inner_structures.yml")
    conf2 = await rxconf.Conf.from_file_async(config_path=_CONF_HASH_DIR / "inner_pseudo_changed.yml")
    conf3 = await rxconf.Conf.from_file_async(config_path=_CONF_HASH_DIR / "inner_structures.json")
...
async def test_async_to_differ_str_and_int():
    conf1 = await rxconf.Conf.from_file_async(config_path=_CONF_HASH_DIR / "simple_struct_with_str.yml")
    conf2 = await rxconf.Conf.from_file_async(config_path=_CONF_HASH_DIR / "simple_structure.yml")
...
async def test_async_key_order():
    conf1 = await rxconf.Conf.from_file_async(config_path=_CONF_HASH_DIR / "key_order_1_2.yml")
    conf2 = await rxconf.Conf.from_file_async(config_path=_CONF_HASH_DIR / "key_order_2_1.yml")
...
async def test_async_set_order_no_matter():
    conf1 = await rxconf.Conf.from_file_async(config_path=_CONF_HASH_DIR / "set_123.yml")
    conf2 = await rxconf.Conf.from_file_async(config_path=_CONF_HASH_DIR / "set_132.yml")
...
async def test_async_real_conf():
    conf1 = await rxconf.Conf.from_file_async(config_path=_CONF_HASH_DIR / "real_conf_file_1.yml")
    conf2 = await rxconf.Conf.from_file_async(config_path=_CONF_HASH_DIR / "real_conf_file_2.yml")
