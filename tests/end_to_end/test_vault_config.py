...
from rxconf import Conf, exceptions
...
def test_primitive_types() -> None:
    conf = Conf.from_vault(token=VAULT_TOKEN, ip=VAULT_ADDR, path="test_vault/vault_primitive_data")
...
def test_inner() -> None:
    conf = Conf.from_vault(token=VAULT_TOKEN, ip=VAULT_ADDR, path="test_vault/vault_inner_data")
